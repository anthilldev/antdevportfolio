...
const LeftText = () => {
  return (
    ...
    <div className="grid grid-col-3 mx-9">
    <h1 className="text-4xl font-bold text-white font-sans place-self-center">WELCOME TO MY PORTFOLIO </h1>
    <p className="relative  text-white font-sans pt-5 ">
      I love what I do and I take every project into my arms with care as if 
      ...
      bugs and broken features forever.
    </p>
    <HeroButton />
    </div>
  )
